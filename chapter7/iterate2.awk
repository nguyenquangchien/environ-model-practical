...
#
# Usage: gawk -f iterate2.awk -v  R_Leaf=value \
...
BEGIN {
   ...
   for (iteration=1;iteration<=20;iteration++){
      ...
      # Print out the number of iterations performed thus far
      # and the estimated spectral reflectance of the canopy 
      # as a whole after that number of iterations
      printf("%-3i %5.4f\n", iteration, I_Up[1]);
   }
